...
![Project status](https://img.shields.io/badge/status-V1%20in%20progress-F2C94C?style=flat-square)
...
Transform static STM GTFS data into a reliable analytical dataset, validate its quality through repeatable controls, and prepare it for reporting.
...
- Built initial analytical tables for routes, stops, services, trips, and scheduled stop times.
...
- Build the **Data Quality Overview** page.
- Document the data model and quality rules.
...
The first executed snapshot passed all 10 implemented data quality controls.
